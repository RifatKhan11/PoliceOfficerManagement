...
using static AlphaManagement.Web.PushNotification.Models.GoogleNotification;
using static AlphaManagement.Web.PushNotification.Services.NotificationService;

namespace AlphaManagement.Web.PushNotification.Services
{
