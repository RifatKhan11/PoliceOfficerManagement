...
{
    public class InternalAssignmentViewModel
    {
        ...
        public IEnumerable<Entity.MasterData.Section> sections { get; set; }
        ...
        public IEnumerable<SectionWiseEmployeeViewModel> unitRankWiseEmployeeViewModels { get; set; }
